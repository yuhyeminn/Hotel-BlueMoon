...
<script>
    function ToResvComplete(){
		location.href = "<%=request.getContextPath()%>/views/reservation/complete";	
	};
</script>
            ...
            <div class="summary-bar-container">
                <div class="summary-barText">
                    <div class="checkInOutDate">
                        <span>2019.12.25 - 2019.12.27</span>
                    </div>
            ...
            <div class="pay-column-row-left">
                ...
                <div class="inner-column">
                    <div class="guest-pay-info">
                        <div class="guestInfo">
                            <span class="guestInfo-title">투숙객 정보</span>
                        </div>
                    </div>
                  ...
                  <div class="price-per-room">
                    <div class="price-per-room-title">
                      ...
                      <ul class="price-per-room-detail">
                        <li>
                          <p class="pprt-date">2019-12-25</p>
                          <p class="pprt-price">
                            <span class="price-unit">KRW</span>
                      ...
                      <ul class="price-per-room-detail">
                          <li>
                            <p class="pprt-date">2019-12-26</p>
                            <p class="pprt-price">
                              <span class="price-unit">KRW</span>
                              <span class="price">580,000</span>
                            </p>
