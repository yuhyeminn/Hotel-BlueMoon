...
<div class="room-detail-container">
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="<%=request.getContextPath()%>/images/sweet.jpg" class="d-block w-100 img-resizing"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="<%=request.getContextPath()%>/images/sweet2.jpg" class="d-block w-100 img-resizing"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="<%=request.getContextPath()%>/images/sweet3.jpg" class="d-block w-100 img-resizing"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="<%=request.getContextPath()%>/images/sweet4.jpg" class="d-block w-100 img-resizing"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="<%=request.getContextPath()%>/images/sweet5.jpg" class="d-block w-100 img-resizing"
					alt="...">
			</div>
		</div>
	...
	<div class="detailTextBox">
		<p class="subTitle">에메랄드 빛 바다를 전망할 수 있는 블루문호텔제주 스위트 오션 룸은 넓고 격조 높은
			객실과 고급스러운 인테리어가 돋보이는 응접실로 구성되어 있습니다. 보다 여유로운 공간에서 색다른 휴식을 즐길 수 있는 고급
			스위트입니다.</p>
	</div>
	...
	<div class="information-section01">
		...
		<ul class="content-col">
			<div class="is-content">
				...
				<div class="content-text">94.4㎡</div>
			</div>
			<div class="is-content">
	...
	<div class="review-section">
		...
		<div class="star-section">
			...
			<div class="reviewTotalCount starText">251 후기</div>
		</div>
	</div>
