...
<div class="room-detail-container">
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="<%=request.getContextPath()%>/images/premiumDelux.jpg" class="d-block w-100 img-resizing"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="<%=request.getContextPath()%>/images/premiumDelux2.jpg" class="d-block w-100 img-resizing"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="<%=request.getContextPath()%>/images/premiumDelux3.jpg" class="d-block w-100 img-resizing"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="<%=request.getContextPath()%>/images/premiumDelux4.jpg" class="d-block w-100 img-resizing"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="<%=request.getContextPath()%>/images/premiumDelux5.jpg" class="d-block w-100 img-resizing"
					alt="...">
			</div>
		</div>
	...
	<div class="detailTextBox">
		<p class="subTitle">블루문호텔 프리미엄 디럭스룸은 잘 가꿔진 야외 정원과 온수풀이 시선을 사로잡고 저
			멀리 풍차와 에메랄드 빛 바다가 조화를 이룬 자연 전경이 펼쳐집니다. 색다른 이국의 낭만을 느낄 수 있는 객실입니다.</p>
	</div>
	...
	<div class="information-section01">
		...
		<ul class="content-col">
			<div class="is-content">
				...
				<div class="content-text">56~65㎡</div>
			</div>
			<div class="is-content">
	...
	<div class="information-section02">
		...
		<ul class="content-col">
			<div class="is-content">
				...
				<div class="content-text-amenities">55” HD TV / 60” HD TV /
					발코니 / 미니바 / 티포트 / 사무용 데스크 (문구류 포함) / 전화기 / 체중계 / 우산</div>
			</div>
		</ul>
		<ul class="content-col">
			<div class="is-content">
	...
	<div class="review-section">
		...
		<div class="star-section">
			...
			<div class="reviewTotalCount starText">351 후기</div>
		</div>
	</div>
	...
	<div class="user-review-context-section">
		...
		<div class="one-context">
			...
			<div class="review-context">프리미엄 디럭스룸 이용. 친절의 끝을 달리는 일반 5성과 다른
				느낌. 여러나라의 호텔을 많이 가봤지만 최고 수준의 친절함.</div>
		</div>
		<div class="one-context">
			<div class="user-profile-pic">
