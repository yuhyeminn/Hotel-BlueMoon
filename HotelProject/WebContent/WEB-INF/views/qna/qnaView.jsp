...
<section>
	...
	<div id="qna-container">
		<p id="qnaNo">
			<span>NO.</span><span id="qna-no"><%=q.getQuestionNo()%></span>
		</p>
		<div id="qna-titlebox" class="content-row">
			<span id="qna-category">[ <%=q.getQuestionCode()%> ]
			</span> <span id="qna-title"><%=q.getQuestionTitle()%></span> <span
				id="qna-date"><%=q.getQuestionDate()%></span>
		</div>
		<div id="qna-content">
		...
		<div id="qna-file" class="content-row">
			<img
				src="<%=request.getContextPath()%>/upload/question/<%=q.getQuestionRenamedFileName()%>"
				id="file-image">
			<div class="txt"></div>
		</div>
		<%
		...
		<div class="comment-editor">
			<form action="<%=request.getContextPath()%>/admin/insertComment"
				method="POST" name="qnaCommentFrm">
		...
		<%
			...
			if ("F".equals(q.getQuestionAnswer())) {
		%>
		<div>
			<form
