...
public class AdminMemberFinderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalContent = 0;
		switch (searchType) {
		case "memberId"	:totalContent = new AdminService().selectTotalMemberContentByMemberId(searchKeyword);break;
		case "memberName" :totalContent = new AdminService().selectTotalMemberContentByMemberName(searchKeyword);break;
		}
		//(공식2)totalPage구하기
		...
		request.getRequestDispatcher("/WEB-INF/views/admin/adminMemberFinder.jsp")
