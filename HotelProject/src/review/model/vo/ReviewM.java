...
public class ReviewM implements Serializable{
	...
	public ReviewM(int reviewNo, String reviewWriter, long resvNo, int roomNo, String reviewContent, Date reviewDate,
			int reviewStarClean, int reviewStarComm, int reviewStarCheckIn, int reviewStarLocation, int reviewStarValue,
			String memberName) {
		super();
	...
	public String toString() {
		return "ReviewM [reviewNo=" + reviewNo + ", reviewWriter=" + reviewWriter + ", resvNo=" + resvNo + ", roomNo="
