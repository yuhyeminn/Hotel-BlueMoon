...
insert into member values('hyemin','VWMd9qoj+9c69+lGrn2fDND2RUHg5DdJYbd+qSqxBFXuqgJnxQzivFRAC1p42wbxLOBuzKpVU50OvfTatNh0aA==','유혜민','19900204','hyemin@hyemin.com','0101111234',default,default);​
...
create table question_board(
    ...
    constraint fk_question_writer foreign key (question_writer) references member(member_id) on delete cascade,
...
constraint fk_resv_member foreign key(resv_member) references member(member_id) on delete cascade,
...
insert into reservation values(to_char(sysdate,'YYYYMMDD')||seq_resv_no.nextval,'qwerty',2,0,0,default,350000,'N','2019-12-29','2019-12-30',0);
...
where member_id ='hyemin' and coupon_enddate >= sysdate and coupon_min <=550000;
...
--월별 통계를 위한 테이블 resvtotal
create table resvtotal(
...
​
--insert resvtotal
insert into resvtotal values(TO_CHAR(TO_DATE(202001, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202002, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202003, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202004, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202005, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202006, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202007, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202008, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202009, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202010, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202011, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(202012, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201901, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201902, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201903, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201904, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201905, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201906, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201907, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201908, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201909, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201910, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201911, 'YYYYMM'), 'YYYYMM'), 0, 0);
insert into resvtotal values(TO_CHAR(TO_DATE(201912, 'YYYYMM'), 'YYYYMM'), 0, 0);
​
--resvtotal 조회
...
insert into resvyeartotal values(TO_CHAR(TO_DATE(2019, 'YYYY'), 'YYYY'), 0, 0);
insert into resvyeartotal values(TO_CHAR(TO_DATE(2020, 'YYYY'), 'YYYY'), 0, 0);
commit;
